...
TEST_CASE("Test replacement of d and t, and lower & upper case") {
    string text = "this report by its very length defends itself against the risk if being read";
    CHECK(find(text, "Tefents") == string("defends"));
    CHECK(find(text, "reporD") == string("report"));
    CHECK(find(text, "hapby") == string("read"));
...
TEST_CASE("Test replacement of p and b") {
    string text = "I have nothing to offer but blood toil tears and sweat ";
...
TEST_CASE("Test replacement of p and b") {
    string text = "Russia is a riddle wrapped in a mystery inside an enigma";
    CHECK(find(text, "happy") == string("happy"));
    CHECK(find(text, "habby") == string("happy"));
    CHECK(find(text, "hapby") == string("happy"));
    CHECK(find(text, "habpy") == string("happy"));
